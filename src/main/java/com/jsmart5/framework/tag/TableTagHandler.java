...
//		builder.append(CLOSE_DIV_TAG);
	...
	private void appendHeaderMultiSelect(StringBuilder builder) {
...
//		builder.append(getSelectCommand(MULTI_SELECT_ALL_INDEX, id + ID_WRAPPER) + "/>");
	...
	private void appendHeaderContent(StringBuilder builder, ColumnTagHandler item) throws JspException, IOException {
...
//		}
	...
	private String getSelectCommand(String indexes, String update) {
...
//		return command;
	...
	private StringBuilder getActionCommand(ACTION action, Object value) {
...
//		return builder;
	...
	private List<Object> getTableContent(Object value, int pageSize) throws JspException {
//
...
// 	 	}
	...
	private StringBuilder getPaginatorWrapper() throws JspException, IOException {
//		if (paginator != null) {
...
//		}
	...
	private StringBuilder getPaginatiorPages() throws JspException, IOException {
//
