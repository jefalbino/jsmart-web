...
public final class RadioGroupTagHandler extends SmartTagHandler {
	...
	public void executeTag() throws JspException, IOException {
		...
		builder.append(CssConstants.CSS_RADIOGROUP + ">");
		builder.append(HtmlConstants.OPEN_TABLE_TAG + CssConstants.CSS_RADIOGROUP_TABLE + ">");

		if (!items.isEmpty()) {

 	 		String columnStyle = CssConstants.CSS_RADIOGROUP_TABLE_COLUMN;
 	 		builder.append(HtmlConstants.OPEN_TABLE_ROW_TAG + CssConstants.CSS_RADIOGROUP_TABLE_ROW + ">");
