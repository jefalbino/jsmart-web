...
public final class SmartEncodeFilter implements Filter {
	...
	private static final Logger LOGGER = Logger.getLogger(SmartEncodeFilter.class.getPackage().getName());
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain) throws IOException, ServletException {
		...
		SmartContentEncode contentEncode = CONFIG.getContent().getContentEncode();
	...
	private boolean isMimeTypeAccepted(HttpServletRequest httpRequest, SmartContentEncode contentEncode) {
	...
	private String getAcceptedEncoding(HttpServletRequest httpRequest, SmartContentEncode contentEncode) {
