...
/*package*/ final class SmartTagEncrypter {
	...
	private static final Logger LOGGER = Logger.getLogger(SmartTagEncrypter.class.getPackage().getName());

	private static Cipher encryptCipher;

	private static Cipher decryptCipher;

	private static boolean encryptTagEnabled = SmartConfig.CONFIG.getContent().isEncryptTags();
