...
$.extend(RealPerson.prototype, {
	...
	_optionPlugin: function(target, options, value) {
		...
		target.prevAll('.' + this.propertyName + '_challenge,.' + this.propertyName + '_hash').
	...
	_generateHTML: function(target, inst) {
		...
		var html = '<div class="' + this.propertyName + '_challenge">' +
			'<div class="' + this.propertyName + '_text">';
		...
		html += '</div><div class="' + this.propertyName + '_regen">' + inst.options.regenerate +
			'</div></div><input type="hidden" class="' + this.propertyName + '_hash" name="' +
			inst.options.hashName +
	...
	_enablePlugin: function(target) {
		...
		target.removeClass(this.propertyName + '_disabled').prop('disabled', false).
			prevAll('.' + this.propertyName + '_challenge').removeClass(this.propertyName + '_disabled');
	},
	...
	_disablePlugin: function(target) {
		...
		target.addClass(this.propertyName + '_disabled').prop('disabled', true).
			prevAll('.' + this.propertyName + '_challenge').addClass(this.propertyName + '_disabled');
	},
	...
	_destroyPlugin: function(target) {
		...
		target.removeClass(this.markerClassName).
			...
			prevAll('.' + this.propertyName + '_challenge,.' + this.propertyName + '_hash').remove();
	},
...
$('div.' + plugin.propertyName + '_challenge').live('click', function() {
	if (!$(this).hasClass(plugin.propertyName + '_disabled')) {
